...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if(json["New_advertisements"] is List) {
      newAdvertisements = json["New_advertisements"] == null ? null : (json["New_advertisements"] as List).map((e) => NewAdvertisements.fromJson(e)).toList();
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if(newAdvertisements != null) {
      _data["New_advertisements"] = newAdvertisements?.map((e) => e.toJson()).toList();
    }
    return _data;
  }
}
...
class NewAdvertisements {
  ...
  NewAdvertisements({this.advertisementId, this.serviceId, this.location, this.neighborhood, this.title, this.userName, this.createdAt1, this.createdAt2, this.photos});
...
class Services {
  ...
  Services.fromJson(Map<String, dynamic> json) {
    ...
    if(json["service_type"] is List) {
      serviceType = json["service_type"] == null ? null : (json["service_type"] as List).map((e) => ServiceType.fromJson(e)).toList();
    }
  }
