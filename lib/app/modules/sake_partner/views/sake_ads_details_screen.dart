...
import '../widgets/quantity_section.dart';
...
class SakePartnerDetailsScreen extends GetView<SakePartnerController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SakePartnerController>(
      builder: (controller) {
        return FutureBuilder<SarificeAdItemModel?>(
            future: SarificeAPIS.getSarificeAdsById(id),
                      ...
                      return [
                        SliverAppBar(
                          ...
                          leading: GestureDetector(
                            onTap: () {
                              Get.back();
                              controller.clearSakeQuantityData();
                            },
                            child: Container(
                              height: 40,
                              width: 40,
